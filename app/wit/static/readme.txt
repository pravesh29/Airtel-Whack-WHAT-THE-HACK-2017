...
We have built a chatbot for self-care and customer experience theme. As organizations continue to automate their sales
and customer service functions in order to reduce costs without degrading the customer experience, chatbots and other
intuitive dialog systems are becoming more popular.

This file is meant to give you a headstart in the understanding of customer stories used in our implementation.
